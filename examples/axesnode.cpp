...
int main( int argc, char** argv )
{
    ...
    viewer.setupWindow( 150, 20, 800, 600 );
	...
	osg::Matrix::ortho2D(0,viewer.width(),0,viewer.height()) );
    ...
    osg::ref_ptr<osgGeo::AxesNode> axes	= new osgGeo::AxesNode;
    axes->setSize( osg::Vec2(5,50) );
    axes->setPosition( osg::Vec2(viewer.width()-60,60) );
    axes->setMasterCamera( viewer.getView()->getCamera() );
    hudview->setSceneData( axes );
